...
from test_framework.uiddconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY

RANDOM_COINBASE_ADDRESS = convert_btc_address_to_uidd('mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ')
...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("We use a third node here that sends 50 uidd to each of the two other nodes to keep compatibility with bitcoin")
