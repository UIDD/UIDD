...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("UIDD");
    case mBTC: return QString("mUIDD");
    case uBTC: return QString::fromUtf8("μUIDD (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Uidds");
    case mBTC: return QString("Milli-Uidds (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Uidds (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
