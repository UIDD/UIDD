#ifndef UIDDVERSIONCHECKER_H
#define UIDDVERSIONCHECKER_H
...
class UiddVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit UiddVersionChecker(QObject *parent = 0);
    ~UiddVersionChecker();
