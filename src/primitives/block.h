...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // uidd
        hashUTXORoot.SetNull(); // uidd
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //uidd
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //uidd
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //uidd
    {
